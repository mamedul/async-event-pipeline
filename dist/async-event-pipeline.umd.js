(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Hooker = factory());
	...
	var asyncEventPipeline;
	var hasRequiredAsyncEventPipeline;

	function requireAsyncEventPipeline () {
		if (hasRequiredAsyncEventPipeline) return asyncEventPipeline;
		hasRequiredAsyncEventPipeline = 1;
		/**
		...
		return asyncEventPipeline;
	}

	var asyncEventPipelineExports = requireAsyncEventPipeline();
	var index = /*@__PURE__*/getDefaultExportFromCjs(asyncEventPipelineExports);
